 ...
 * Instead, change the Travel/Trip.js file.
 *
 * @module Travel
 */
...
Base.table = function (withoutDbName) {
	if (Q.Config.get(['Db', 'connections', 'Travel', 'indexes', 'Trip'], false)) {
		return new Db.Expression((withoutDbName ? '' : '{{dbname}}.')+'{{prefix}}trip');
	} else {
		var conn = Db.getConnection('Travel');
		var prefix = conn.prefix || '';
		var tableName = prefix + 'trip';
 ...
 * @type string
 */
Base.prototype.className = "Travel_Trip";
 ...
 * @throws {Error} An exception is thrown if 'value' is not string or is exceedingly long
 */
Base.prototype.beforeSet_directions = function (value) {
		if (value == undefined) return value;
		if (value instanceof Db.Expression) return value;
		if (typeof value !== "string" && typeof value !== "number")
			throw new Error('Must pass a String to '+this.table()+".directions");
		if (typeof value === "string" && value.length > 16777216)
			throw new Error('Exceedingly long value being assigned to '+this.table()+".directions");
		return value;
};
	 ...
	 * @return {integer}
	 */
Base.prototype.maxSize_directions = function () {
 ...
 * @throws {Error} An exception is thrown if 'value' is not string or is exceedingly long
 */
Base.prototype.beforeSet_coordinates = function (value) {
		if (value == undefined) return value;
		if (value instanceof Db.Expression) return value;
		if (typeof value !== "string" && typeof value !== "number")
			throw new Error('Must pass a String to '+this.table()+".coordinates");
		if (typeof value === "string" && value.length > 65535)
			throw new Error('Exceedingly long value being assigned to '+this.table()+".coordinates");
		return value;
};
	 ...
	 * @return {integer}
	 */
Base.prototype.maxSize_coordinates = function () {
